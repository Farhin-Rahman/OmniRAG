...
Any language promising guaranteed or fixed returns, profit-sharing from pooled funds, "double your money," or payouts that grow as more people join is a Ponzi/investment-scheme pattern and should be rejected outright, regardless of how the campaign frames its charitable purpose.
...
When a campaign is plausible but unverifiable — no named institution, no itemized costs, no documentation offered, only a sympathetic story — escalate it for a human reviewer rather than approving or rejecting automatically. Unverifiable medical, personal-hardship, and "fund my idea" appeals are a common fraud pattern, but they are also how many genuine grassroots campaigns start; the correct handling is human judgment, not an automated guess in either direction.
